...
<div class="row" id="proBanner">
  ...
  <div class="container-scroller">
   ...
   @include('header')
   @include('underheader',['page'=>'Voir Visiteurs/Ecroues'])
...
$(function(){
    ...
    fetchAllErouesvisitors();

function fetchAllErouesvisitors(){

       $.ajax({

              url:'{{ route('commandantfetch_all_ecroues_visitors') }}',
              method:'GET',
                ...
                Swal.fire({
                   ...
                   $.ajax({
                        ...
                        success:function(res){
                                    ...
                                    window.open("/commandantprintpersonnels/"+res.ids);
