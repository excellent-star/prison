...
@section('page_title','modification-evenement')
@section('content')
<div class="row" id="proBanner">
  ...
  <div class="container-scroller">
   ...
   @include('header')
   @include('underheader',['page'=>'Modification Evenement'])
                                      ...
                                      <input type="hidden" name="id" value="{{ $event->id }}">
                                         ...
                                         <div class="col-sm-4">
                                                ...
                                                <div id="form-group">
                                                    ...
                                                    <input name="title" type="text" class="form-control" id="title" placeholder="Titre evenement" value="{{ $event->title }}" required>
                                                </div>
                                         ...
                                         <div class="col-sm-4">
                                                ...
                                                <div id="form-group">
                                                    ...
                                                    <input name="event_date" type="date" class="form-control" id="event_date" placeholder="Date de l'evenement"  value="{{ $event->event_date }}"  required>
                                                </div>
                                         </div>
                                         ...
                                         <div class="col-sm-4">
                                            ...
                                            <div id="form-group">
                                                ...
                                                <input name="event_time" type="tel" class="form-control" id="event_time" placeholder="l'heure de l'evenement" value="{{ $event->event_time }}" required>
                                            </div>
                                     </div>
                                ...
                                <div class="row my-5">
                                    ...
                                    <div class="col-sm-12">
                                           ...
                                           <div id="form-group">
                                               ...
                                               <textarea name="description" rows="10" cols="50" id="description" class="form-control">{{ $event->description }}</textarea>
                                           </div>
