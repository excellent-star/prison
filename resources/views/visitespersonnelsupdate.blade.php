                            ...
                            <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div id="form-group">
                                                ...
                                                <select name="service_id" class="form-control" id="service_visite">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div id="form-group">
                                                ...
                                                <input name="grade_visite" type="text" class="form-control" id="grade_visite" placeholder="Grade du visité" value="{{ $visites->grade_visite }}" required>
                                            </div>
...
getServices('#direction_visite');
 ...
 $('#direction_visite').on('change',function(){
    ...
    $("#visite_personnel_form_id").submit(function(e){
           ...
           $.ajax({
            type: "POST",
            url: '{{ route("visitespersonnelsupdaterun") }}',
            data: formData,
            processData: false,
            contentType: false,
            success:function(res){
